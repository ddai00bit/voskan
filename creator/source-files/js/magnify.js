	...
	$(".magnify").mousemove(function(e){
		...
		else
		{
			...
			if(get_position == true){
				...
				{
					//The background position of .magnified will be changed according to the position
					...
					style = "display: block; background: url('url-to-background-goes-here') no-repeat; left: " + px + "px; top: " + py + "px; background-position: " + bgp + ";";
				}
			}
		}
	})
