...
$(document).ready(function(){
	...
	if($("#headerwrap").hasClass("overlay")){
		...
		//Keep patterns in different directory? Change the path to your pattern folder below
		bgProperty = "background-image: url('../assets/voskan-assets/patterns/" + patternName + "');";
	...
	if($(".block-8").length){
		...
		$( ".block-8" ).each(function() {
			...
			//Keep patterns in different directory? Change the path to your pattenr foloder below
			bgProperty = "background-image: url('../assets/voskan-assets/patterns/" + patternName + "');";
